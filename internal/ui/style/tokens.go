...
var (
	...
	Grey50  = lipgloss.Color("#FAFAFA")
	Grey100 = lipgloss.Color("#F3F4F6")
	Grey200 = lipgloss.Color("#E5E7EB")
	Grey300 = lipgloss.Color("#D1D5DB")
	Grey400 = lipgloss.Color("#9CA3AF")
	Grey500 = lipgloss.Color("#6B7280")
	Grey600 = lipgloss.Color("#4B5563")
	Grey700 = lipgloss.Color("#374151")
	Grey800 = lipgloss.Color("#1F2937")
	Grey900 = lipgloss.Color("#111827")
...
var (
	FgPrimary   = baseStyle.Foreground(Primary)
	FgSecondary = baseStyle.Foreground(Secondary)
	FgAccent    = baseStyle.Foreground(Accent)

	FgSuccess = baseStyle.Foreground(Success)
	FgWarning = baseStyle.Foreground(Warning)
	FgError   = baseStyle.Foreground(Error)
	FgInfo    = baseStyle.Foreground(Info)
	FgMuted   = baseStyle.Foreground(ColorMuted)

	FgRed    = baseStyle.Foreground(Red500)
	FgGreen  = baseStyle.Foreground(Green500)
	FgBlue   = baseStyle.Foreground(Blue500)
	FgYellow = baseStyle.Foreground(Yellow500)
	FgPurple = baseStyle.Foreground(Purple500)
	FgPink   = baseStyle.Foreground(Pink500)
	FgCyan   = baseStyle.Foreground(Cyan500)
	FgOrange = baseStyle.Foreground(Orange500)

	FgWhite = baseStyle.Foreground(White)
	FgBlack = baseStyle.Foreground(Black)
	FgGray  = baseStyle.Foreground(Grey500)
)

// Semantic background colors
var (
	BgPrimary   = baseStyle.Background(Primary)
	BgSecondary = baseStyle.Background(Secondary)
	BgAccent    = baseStyle.Background(Accent)

	BgSuccess = baseStyle.Background(Success)
	BgWarning = baseStyle.Background(Warning)
	BgError   = baseStyle.Background(Error)
	BgInfo    = baseStyle.Background(Info)
	BgMuted   = baseStyle.Background(ColorMuted)

	BgRed    = baseStyle.Background(Red500)
	BgGreen  = baseStyle.Background(Green500)
	BgBlue   = baseStyle.Background(Blue500)
	BgYellow = baseStyle.Background(Yellow500)
	BgPurple = baseStyle.Background(Purple500)
	BgPink   = baseStyle.Background(Pink500)
	BgCyan   = baseStyle.Background(Cyan500)
	BgOrange = baseStyle.Background(Orange500)

	BgWhite = baseStyle.Background(White)
	BgBlack = baseStyle.Background(Black)
	BgGray  = baseStyle.Background(Grey500)

	BgSurface        = baseStyle.Background(SurfaceColor)
	BgSurfaceVariant = baseStyle.Background(SurfaceVariantColor)
)

// Border colors
var (
	BrPrimary   = baseStyle.BorderForeground(Primary)
	BrSecondary = baseStyle.BorderForeground(Secondary)
	BrAccent    = baseStyle.BorderForeground(Accent)

	BrSuccess = baseStyle.BorderForeground(Success)
	BrWarning = baseStyle.BorderForeground(Warning)
	BrError   = baseStyle.BorderForeground(Error)
	BrInfo    = baseStyle.BorderForeground(Info)
	BrMuted   = baseStyle.BorderForeground(ColorMuted)

	BrRed    = baseStyle.BorderForeground(Red500)
	BrGreen  = baseStyle.BorderForeground(Green500)
	BrBlue   = baseStyle.BorderForeground(Blue500)
	BrYellow = baseStyle.BorderForeground(Yellow500)
	BrPurple = baseStyle.BorderForeground(Purple500)
	BrPink   = baseStyle.BorderForeground(Pink500)
	BrCyan   = baseStyle.BorderForeground(Cyan500)
	BrOrange = baseStyle.BorderForeground(Orange500)

	BrWhite = baseStyle.BorderForeground(White)
	BrBlack = baseStyle.BorderForeground(Black)
	BrGray  = baseStyle.BorderForeground(Grey500)
)

// Base semantic colors (добавляем к существующим)
var (
	Primary   = Blue600
	Secondary = Purple600
	Accent    = Pink500
...
var (
	...
	TextMuted    = baseStyle.Foreground(ColorMuted)
	TextDim      = baseStyle.Foreground(Grey400).Faint(true)
	TextSubtle   = baseStyle.Foreground(Grey500)
	TextEmphasis = baseStyle.Foreground(Grey800).Bold(true)
)
